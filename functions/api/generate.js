...
function buildSystemPrompt() {
  return [
    ...
    "CourseForge circuit DSL commands are: size W H; node ID X Y; wire A B; dot A; resistor R1 2ohm A B; lamp L A B; switch S1 A B open; switch S1 A B closed; ammeter A A B; battery U_S 12V A B; voltage US 12V A B; current IS 3A A B; arrow I A B; ground G; label text X Y. Use coordinates to define a readable textbook-style SVG layout.",
