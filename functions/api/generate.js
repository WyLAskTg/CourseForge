...
function buildSystemPrompt() {
  return [
    ...
    "When a problem needs a diagram, draw it directly inside item.body as a fenced text block labeled diagram. For circuit problems, use a fenced text block labeled circuit and draw a readable ASCII circuit with component names, values, sources, current directions, and node labels.",
